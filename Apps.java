...
public class Apps {
	...
	private void initialize() {
		...
		ImagePanel loginPanel = new ImagePanel(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\theme.jpg").getImage());
		currPanel = loginPanel;
		ImagePanel tranPanel = new ImagePanel(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\Activation.jpg").getImage());
		
		frame.setSize(loginPanel.getDim());
		frame.setPreferredSize(loginPanel.getDim());
		ImagePanel sumPanel = new ImagePanel(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\Activation.jpg").getImage());
		...
		tranBtn.setIcon(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\Transaction.jpg"));
		...
		logInBtn.setIcon(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\button.jpg"));
		logInBtn.setPressedIcon(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\btnClicked.jpg"));
		
		// Transaction
		
		JButton sumBtn = new JButton("");
		sumBtn.setIcon(new ImageIcon("C:\\Users\\kevin\\OneDrive\\Desktop\\app 파일\\Summary.jpg"));
